      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-gradient-to-r from-primary to-secondary text-white px-6 py-3 rounded-xl">
              <div className="text-2xl font-bold">10,000+</div>
              <div className="text-sm opacity-90">довольных клиентов</div>
            </div>
            <div className="bg-gradient-to-r from-secondary to-accent text-white px-6 py-3 rounded-xl">
              <div className="text-2xl font-bold">99.8%</div>
              <div className="text-sm opacity-90">доставка в срок</div>
            </div>
          </div>
        </div>
