...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Организация переездов квартир, офисов с упаковкой и грузчиками',
      features: ['Профессиональные грузчики', 'Упаковочные материалы', 'Сборка-разборка мебели']
    },
    {
      icon: 'Package',
      title: 'Сборные грузы',
    ...
    },
    {
      ...
      features: ['Приёмка по стандартам', 'Все документы', 'Быстрые сроки']
    },
    {
      icon: 'Shield',
